# Org.OpenAPITools - the C# library for the MoviesAndSeries.Server
...
------------ | ------------- | ------------- | -------------
*SeriesApi* | [**ApiSeriesGet**](docs\SeriesApi.md#apiseriesget) | **GET** /api/Series | 
